  ...
  const sincronizarEmpresa = async (idSistema: number, empresa: string, type: 'total' | 'partial' = 'total', startPage?: number) => {
    try {
      ...
      const params = new URLSearchParams({
        idSistema: idSistema.toString(),
        empresa: empresa,
        type: type
      })
      if (startPage !== undefined) params.append('startPage', startPage.toString())

      const response = await fetch(`/api/sync/estoques?${params.toString()}`, {
        method: 'POST'
      })
